...
public class TokenUtil {
    ...
    public static String getTokenGenerator(String agent, ItripUser us) {
        try {
            ...
            sb.append(com.utils.MD5Util.getMd5(us.getUsercode(), 32) + "-");//加密用户名称
            sb.append(us.getId() + "-");
            sb.append(new SimpleDateFormat("yyyyMMddHHmmss").format(new Date())
                    + "-");
            sb.append(com.utils.MD5Util.getMd5(agent, 6));// 识别客户端的简化实现——6位MD5码
    ...
    public static boolean validate(String agent, String token) {
        ...
        try {
            ...
            if (com.utils.MD5Util.getMd5(agent, 6).equals(agentMD5))
                return true;
